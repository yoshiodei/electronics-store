...
export default function SignInModal({
  ...
  //   const userNumber = phoneNumber.charAt(0) === '+' ? `${phoneNumber}@electrotoss.com`
  // : `+233${phoneNumber}@electrotoss.com`;
  ...
  //               {' '}
  //               <button className="switch-to-signin__button" type="button"
  // onClick={handleModalSwitch}>Register</button>
  //             </h6>
  //           </div>
  //         </div>
  //       </Modal.Body>
